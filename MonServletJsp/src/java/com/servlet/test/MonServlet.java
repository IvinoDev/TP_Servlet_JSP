...
public class MonServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("envoyer") != null) {
            ...
            if (nom.trim().equals("")|| prenom.trim().equals("") || pseudo.trim().equals("") || mail.trim().equals("") ||
                    password.trim().equals("") || passwordv.trim().equals("")) {
                ...
                if (password.equals(passwordv)) {
                    ...
                    request.setAttribute("erreur", "Vos mots de passe ne sont pas les mêmes");
                    request.getRequestDispatcher("inscrire.jsp").forward(request, response);
